...
local options = {
	...
	cmdheight = 1, -- No height for cmd commands (plugin Noice)
...
local globals = {
	loaded_python3_provider = disable,
	loaded_perl_provider = disable,
	markdown_recommended_style = disable,
	netrw_altfile = enable,
	netrw_usetab = enable,
	netrw_banner = disable,
	netrw_cursor = disable,
	netrw_liststyle = 3,
