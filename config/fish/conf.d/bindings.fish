...
function edit_fish_shell;source $__fish_config_dir/config.fish && commandline -f repaint; end
bind -M default \er 'edit_fish_shell'
...
#C-e
function _explorer; ranger 2> /dev/null; end
